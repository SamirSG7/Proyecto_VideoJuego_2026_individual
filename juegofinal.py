...
class Game:
    ...
    def update(self):
        ...
        if self.player.dead:
            if self.state == 'PLAYING':
                ...
                #save_record("Naruto", self.score)

                #print("Descargando tabla de clasificación...")
                #self.top_scores = obtener_top()
    ...
    def draw(self, screen):
        ...
        if self.state=='INPUT_NAME':
            ...
            # Renderizar las letras que el usuario va escribiendo
        ...
        if self.state == 'START':
            ...
            if len(self.top_scores)==0:
                ...
                for i, jugador in enumerate(self.top_scores):
                    ...
                    render_pos = font_small.render(pos_text, True,WHITE if i > 0 else YELLOW)  # El 1er lugar brilla en amarillo
