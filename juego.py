...
class Player(Entity):
    ...
    def __init__(self):
        ...
        try:
            # 1. Cargar la hoja de sprites completa
...
# --- ENEMIGOS ---
class Enemy(Entity):
    # Caché de sprites (variables de clase) para no causar lag al crear muchos enemigos
    sprites_ninja = []
    sprites_tank = []
    ...
    def cargar_sprites(cls):
        ...
        try:
            ...
            hoja_ninja = pygame.image.load("enemigo2.png").convert_alpha()
        ...
        try:
            ...
            hoja_tank = pygame.image.load("tank2.png").convert_alpha()
